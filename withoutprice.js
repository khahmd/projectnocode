...
// Fonction pour récupérer et supprimer les produits sans prix avec pagination
async function deleteProductsWithoutPrice(pageInfo = null) {
    try {
        ...
        for (const product of products) {
            ...
            // Vérifier chaque variante du produit
            ...
            // Si aucune variante n'a un prix valide, supprimer le produit
            if (!hasValidPrice) {
                console.log(`Produit sans prix trouvé : ${product.id}, ${product.title}`);
        ...
        if (linkHeader && linkHeader.includes('rel="next"')) {
            ...
            await deleteProductsWithoutPrice(nextPageInfo); // Appel récursif pour la page suivante
        } else {
...
// Appel de la fonction pour supprimer les produits sans prix
